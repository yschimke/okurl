...
object Deps {
  ...
  val jnrUnixSocket = "com.github.jnr:jnr-unixsocket:${Versions.unixSocket}"
  ...
  val ok2Curl = "com.github.mrmike:ok2curl:${Versions.okcurl}"
  ...
  val zipkin = "io.zipkin.java:zipkin:${Versions.zipkin}"
  val zipkinSenderOkhttp3 = "io.zipkin.reporter2:zipkin-sender-okhttp3:${Versions.zipkinOkhttp}"
