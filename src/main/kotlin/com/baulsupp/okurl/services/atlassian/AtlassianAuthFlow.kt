...
object AtlassianAuthFlow {
  suspend fun login(
    ...
    SimpleWebServer.forCode().use { s ->
      ...
      val loginUrl = "https://auth.atlassian.com/authorize?audience=api.atlassian.com&client_id=$clientId&scope=$scopeString&redirect_uri=${serverUriEncoded}&response_type=code&prompt=consent&state=secret"
