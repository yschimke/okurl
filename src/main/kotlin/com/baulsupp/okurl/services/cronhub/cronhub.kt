...
data class MonitorsResponse(val success: Boolean,
                            val response: List<ResponseItem>)

data class EventTime(val date: String,
                     val timezone: String,
                     val timezone_type: Int)

data class ResponseItem(val schedule: String,
                        val code: String,
...
data class MonitorStatus(val success: Boolean,
