...
object FitbitAuthCodeFlow {
  suspend fun login(client: OkHttpClient, outputHandler: OutputHandler<Response>, clientId: String,
    ...
    SimpleWebServer.forCode().use { s ->
      ...
      val loginUrl = "https://www.fitbit.com/oauth2/authorize?client_id=$clientId&response_type=code&redirect_uri=${URLEncoder.encode(s.redirectUri, "UTF-8")}&scope=$scopesString"
