...
data class User(val businessPhones: List<String>?, val preferredLanguage: String?, val mail: String?, val mobilePhone: String?,
                val officeLocation: String?, val displayName: String, val surname: String?, val givenName: String?, val jobTitle: String?,
                val id: String, val userPrincipalName: String?)
...
data class DriveItem(val lastModifiedDateTime: String, val lastModifiedBy: LastModifiedBy?, val createdDateTime: String,
                     val parentReference: ParentReference?, val folder: Folder?, val size: Int, val createdBy: CreatedBy,
                     val webUrl: String, val name: String, val cTag: String?, val eTag: String?, val id: String,
                     val specialFolder: SpecialFolder?, val fileSystemInfo: FileSystemInfo?)
